...
def test_context_design_and_domain_design():
    cd = ContextDesign(
        ...
        cobol_mapping=[CobolMapping(cobol_ref="PGM1.PARA1", maps_to="Transaction.post",
